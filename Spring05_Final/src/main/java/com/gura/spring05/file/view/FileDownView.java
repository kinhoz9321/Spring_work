 ...
 */
@Component("fileDownView") //빈의 이름 정의
public class FileDownView extends AbstractView{

	//이 메소드에서 클라이언트에게 응답하면 된다. Map<String, Object> model modelandview 에 담겼던 객체가 map 에 담겨서 전달됨.
	@Override
	protected void renderMergedOutputModel(Map<String, Object> model, HttpServletRequest request,
		...
		//응답 헤더 정보 설정 (어떤 컨텐츠를 줄지 준비시키고 받게 함 밑에 while문 돌면서 파일을 만들어내는데 어떤 파일을 만들지 웹브라우저에게 준비시킴.)
		...
		while(true){
			...
			//buffer 배열의 0번 방에서부터 ~ 읽은 만큼 출력하기
